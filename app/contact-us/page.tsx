      ...
      <section className="bg-pink-100 py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-700 max-w-2xl mx-auto">
            We'd love to hear from you! Get in touch with us for any questions or to schedule a consultation.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Whether you're ready to start planning your wedding or just have some questions, we're here to help.
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-red-100 p-2 rounded-full text-red-700 hover:bg-red-200">
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-red-700 mb-2">Our Location</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Visit our office in Nagpur to discuss your wedding plans in person.
            </p>
          </div>
